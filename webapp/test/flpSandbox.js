		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#JARRSPACEinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"JARRSPACEinvoice-display": {
								"semanticObject": "JARRSPACEinvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=JARRSPACE.invoice",
									"url": sap.ui.require.toUrl("JARRSPACE/invoice")
								}
							}
						}
					}
